def main() -> None:
    ...
    # Végtelen ciklus: olyan ciklus, aminek a feltétele sosem lesz hamis (pl.: while True),
    # ezért önmagától sosem állna le. Egy vezérlő utasítással (jellemzően break-kel,
    # egy feltételhez kötve) belülről kell kiléptetni, különben a program "lefagy".
    # Tipikus felhasználása: addig ismételjünk, amíg a felhasználó be nem gépel egy
    # megállító (végjel) értéket.
    print('Végtelen ciklus (while True) + break')
    i = 0
    while True:
        i += 1
        print(i, end=' ')  # 1 2 3 4 5
        if i == 5:  # e nélkül a feltétel nélkül a ciklus sosem érne véget
            break
    print()
