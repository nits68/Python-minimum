...
def main() -> None:
    ...
    print('String összefűzése (+) és replikációja (*)')
    print('ab' + 'cd')  # abcd - összefűzés
    print('ab' * 3)  # ababab - a string 3-szori megismétlése
    print('-' * 20)  # elválasztó vonal készítésének gyakori módja

    print('String -> karakterlista konvertálása a list() függvénnyel')
